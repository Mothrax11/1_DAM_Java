...
public class MediaValoresArray {
    ...
    public static void main(String[] args) {
        ...
        int [] arraymedia = new int [sc.nextInt()];
        rellenar(arraymedia);
        System.out.println(arrayToString(arraymedia));
        System.out.println("La suma de todos los elementos del array es: "+ media(arraymedia));
        sc.close();
    }
